...
tle_ntuple = cms.EDAnalyzer('Ntuplizer',
                                   ...
                                   photonID2 = cms.string("PhotonMVAEstimatorRun2Spring15NonTrig25nsV2"),
...
process.p = cms.Path(process.electronMVAValueMapProducer * process.reg_signal * process.reg_background)#*process.dump)
